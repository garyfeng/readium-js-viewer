...
define(['module','jquery', 'bootstrap', 'URIjs', 'Readium', 'Spinner', 'storage/Settings', 'i18n/Strings', 'Dialogs', 'ReaderSettingsDialog', 
        'hgn!templates/about-dialog.html', 'hgn!templates/reader-navbar.html', 'hgn!templates/reader-body.html', 'analytics/Analytics', 'screenfull', 'Keyboard', 'EpubReaderMediaOverlays', 'GesturesHandler'],
        function (module, $, bootstrap, URI, Readium, spinner, Settings, Strings, Dialogs, SettingsDialog, AboutDialog, ReaderNavbar, ReaderBody, Analytics, screenfull, Keyboard, EpubReaderMediaOverlays, GesturesHandler) {
...
catch (e)
{
    ...
    var initReadium = function(){
        ...
        Settings.getMultiple(['reader', url], function(settings){
            ...
            gestureHandler = new GesturesHandler(readium.reader, $('#epub-reader-container'));

            gestureHandler.on(GesturesHandler.Events.TOUCH_SWIPELEFT, function(){
                readium.reader.openPageLeft();
            });

            gestureHandler.on(GesturesHandler.Events.TOUCH_SWIPERIGHT, function(){
                readium.reader.openPageRight();
            });
